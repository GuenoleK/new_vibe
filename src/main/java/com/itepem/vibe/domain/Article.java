...
public class Article implements Serializable {
    ...
    public Article editionDate(LocalDate editionDate) {
    ...
    public Structure getStrcture() {
        return strcture;
    }

    public Article strcture(Structure structure) {
        this.strcture = structure;
        return this;
    }
