...
public class ArticleResourceIT {
    ...
    public void createArticle() throws Exception {
        ...
        assertThat(testArticle.getEditionDate()).isEqualTo(DEFAULT_EDITION_DATE);
    }
    ...
    @Test
    @Transactional
    public void checkEditionDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = articleRepository.findAll().size();
        // set the field null
        article.setEditionDate(null);
    ...
    public void updateArticle() throws Exception {
        ...
        assertThat(testArticle.getEditionDate()).isEqualTo(UPDATED_EDITION_DATE);
    }
