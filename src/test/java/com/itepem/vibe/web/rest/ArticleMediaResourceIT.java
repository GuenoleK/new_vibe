...
/**
 * Integration tests for the {@Link ArticleMediaResource} REST controller.
 */
@SpringBootTest(classes = VibeApp.class)
public class ArticleMediaResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static ArticleMedia createUpdatedEntity(EntityManager em) {
        ArticleMedia articleMedia = new ArticleMedia()
            .name(UPDATED_NAME);
        return articleMedia;
    }
